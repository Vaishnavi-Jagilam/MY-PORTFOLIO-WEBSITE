  ...
  const experience = [
    {
      ...
      points: [
        ...
        "Led team of 3 developers in agile development practices"
      ]
    },
    {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-0 border-b border-glass-border rounded-none">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button 
              className="btn-primary text-primary-foreground font-medium"
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="glass-card p-12 rounded-3xl slide-in-up">
              <img 
                ...
                alt="Vaishnavi Jagilam"
                className="w-32 h-32 rounded-full mx-auto mb-8 border-4 border-primary glow-primary"
              />
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button 
                  className="btn-primary text-primary-foreground font-medium text-lg px-8 py-3"
                ...
                <Button 
                  className="btn-secondary text-secondary-foreground font-medium text-lg px-8 py-3"
                  onClick={() => window.open('#', '_blank')}
                >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="slide-in-right">
                <img 
                  ...
                  className="rounded-2xl glass-card p-2"
                />
              </div>
            </div>
              ...
              <Card className="glass-card p-6 hover:glow-primary transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.frontend.map((skill) => (
                    <span key={skill} className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm border border-primary/20">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <Card className="glass-card p-6 hover:glow-secondary transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.backend.map((skill) => (
                    <span key={skill} className="bg-secondary/10 text-secondary px-3 py-1 rounded-full text-sm border border-secondary/20">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <Card className="glass-card p-6 hover:glow-accent transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.tools.map((skill) => (
                    <span key={skill} className="bg-accent/10 text-accent px-3 py-1 rounded-full text-sm border border-accent/20">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              {projects.map((project, index) => (
                <Card key={index} className="glass-card p-6 group hover:scale-105 transition-all duration-300">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button 
                      variant="outline" 
                      className="flex-1 group-hover:border-secondary group-hover:text-secondary transition-colors"
              ...
              {experience.map((exp, index) => (
                <div key={index} className={`mb-12 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:ml-auto'} md:w-1/2`}>
                  <Card className="glass-card p-6 relative">
                    <div className="absolute top-6 hidden md:block w-4 h-4 bg-primary rounded-full -translate-y-1/2" 
                         style={{
                    ...
                    <h3 className="text-xl font-orbitron font-semibold mb-1">{exp.role}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <Card className="glass-card p-8">
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      className="w-full p-3 rounded-lg bg-muted/50 border border-muted text-foreground focus:border-primary focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea 
                      rows={4}
                      className="w-full p-3 rounded-lg bg-muted/50 border border-muted text-foreground focus:border-primary focus:outline-none transition-colors resize-none"
              ...
              <div className="space-y-8">
                <Card className="glass-card p-8">
                  ...
                  <div className="flex space-x-4">
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="hover:border-primary hover:text-primary hover:glow-primary transition-all duration-300"
                    ...
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="hover:border-secondary hover:text-secondary hover:glow-secondary transition-all duration-300"
                    ...
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="hover:border-accent hover:text-accent hover:glow-accent transition-all duration-300"
                      onClick={() => window.open('mailto:vaishnavi.jagilam@email.com')}
                    >
                ...
                <Card className="glass-card p-8 text-center">
                  ...
                  <Button 
                    className="btn-secondary text-secondary-foreground font-medium w-full"
                    onClick={() => window.open('#', '_blank')}
                  >
                    <Download className="w-4 h-4 mr-2" />
                    Download PDF Resume
